...
def save_output(image_name, pred, d_dir, sigma=2, alpha=0.5):
    ...
    # print("image comp: "+im_comp.shape)
...
def main():
    ...
    parser.add_argument('-s', action='store', dest='sigma', default=100)
    parser.add_argument('-a', action='store', dest='alpha', default=0.25)
    ...
    image_dir = './test_data/my_test_images'
    prediction_dir = './test_data/my_test_results'
